  ...
  return (
    <nav className="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700 transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center max-md:h-fit h-16 flex-wrap max-md:flex-col max-md:items-start max-md:space-x-0 gap-4 mb-4">
          ...
          <div className="flex items-center space-x-4 flex-wrap max-md:flex-col max-md:items-start max-md:space-x-0 max-md:space-y-0 max-md:w-full max-md:grid grid-cols-2 gap-4">
            <Link
              to="/config"
            ...
            <Link
              ...
              className={`flex items-center space-x-2 px-4 py-2 rounded-lg transition-colors duration-200 ${
                isActive('/preview')
                  ? 'bg-blue-800 text-white'
                    : 'text-gray-700 dark:text-gray-300 hover:bg-purple-800 hover:text-white dark:hover:bg-purple-900'
              }`}
